...
extern  void    FlexCAN_EnableBusOff_Interrupt(void);
extern  void    FlexCAN_DisableBusOff_Interrupt(void);
extern  void    FlexCAN_EnableError_Interrupt(void);
extern  void    FlexCAN_DisableError_Interrupt(void);
extern  void    FlexCAN_EnableTxWarning_Interrupt(void);
extern  void    FlexCAN_DisableTxWarning_Interrupt(void);
extern  void    FlexCAN_EnableRxWarning_Interrupt(void);
extern  void    FlexCAN_DisableRxWarning_Interrupt(void);
extern  void    FlexCAN_EnableWakeup_Interrupt(void);
extern  void    FlexCAN_DisableWakeup_Interrupt(void);
extern  void    FlexCAN_EnableIMEU_Interrupt(void);
extern  void    FlexCAN_DisableIMEU_Interrupt(void);
extern  void    FlexCAN_EnableLostRx_Interrupt(void);
extern  void    FlexCAN_DisableLostRx_Interrupt(void);
