...
#define FLEXCAN_SELF_RECEPTION    1       /* enable self-reception: 0 - disable self-reception; 1 -- enable self-reception */
...
#define FLEXCAN_LOOP_BACK         1       /* loop back for single node: 0 -- no loopback, 1 -- loopback */
