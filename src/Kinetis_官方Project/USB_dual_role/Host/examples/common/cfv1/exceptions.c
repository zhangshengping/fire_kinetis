...
#if REGISTER_ABI
__declspec(register_abi) asm void asm_exception_handler(void)
{
   link     a6,#0 
   lea     -20(sp), sp
...
/*
 *  MCF51MM256 & MCF51JE256 vector table
...
__declspec(weak) vectorTableEntryType vector_65  @Vlvd = asm_exception_handler;
__declspec(weak) vectorTableEntryType vector_66  @Vlol = asm_exception_handler;
__declspec(weak) vectorTableEntryType vector_67  @Vusb = asm_exception_handler;
...
__declspec(weak) vectorTableEntryType vector_72  @VReserved72 = asm_exception_handler;
...
__declspec(weak) vectorTableEntryType vector_93  @VReserved93 = asm_exception_handler;
...
__declspec(weak) vectorTableEntryType vector_110 @VReserved110 = asm_exception_handler;
__declspec(weak) vectorTableEntryType vector_111 @VReserved111 = asm_exception_handler;
