...
#define SCL_OUT   GPIO_DDR_1bit(PORTA,10,1)      //SCL-PA0设置为输出端口
#define SDA_OUT   GPIO_DDR_1bit(PORTA,11,1)      //SDA-PA1设置为输出端口
#define SDA_IN    GPIO_DDR_1bit(PORTA,11,0)      //SDA-PA1设置为输入端口
