...
#define  LIB_VERSION                                     133u   /* See Note #1.                                         */
...
/*$PAGE*/
                                                                /* ----------------- INTEGER DEFINES ------------------ */
#define  DEF_INT_08_NBR_BITS                               8uL
...
#define  DEF_INT_16_NBR_BITS                              16uL
...
#define  DEF_INT_32_NBR_BITS                              32uL
...
#define  DEF_INT_64_NBR_BITS                              64uL
...
*                                            MATH MACRO'S
*
* Note(s) : Ideally, ALL mathematical macro's & functions SHOULD be defined in the custom mathematics 
